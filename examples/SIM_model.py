...
class SFCModel(object):
    ...
    @staticmethod
    def Iterator(in_vec):
        Cs, Gs, Ts, Ns, YD, Td, Cd, Hh, Y, Nd, alpha1, alpha2, theta, W, t, LAG_Hh, t_minus_1, Gd = in_vec 
        NEW_Cs = Cd
        NEW_Gs = Gd
        NEW_Ts = Td
        NEW_Ns = Nd
        ...
        NEW_Gd = Gd
        return NEW_Cs, NEW_Gs, NEW_Ts, NEW_Ns, NEW_YD, NEW_Td, NEW_Cd, NEW_Hh, NEW_Y, NEW_Nd, NEW_alpha1, NEW_alpha2, NEW_theta, NEW_W, NEW_t, NEW_LAG_Hh, NEW_t_minus_1, NEW_Gd
    ...
    def RunOneStep(self):
        ...
        orig_vector = (Cs, Gs, Ts, Ns, YD, Td, Cd, Hh, Y, Nd, alpha1, alpha2, theta, W, t, LAG_Hh, t_minus_1, Gd)
        err = 1.
        cnt = 0
        ...
        Nd = orig_vector[9]
        self.Nd.append(Nd)
        alpha1 = orig_vector[10]
        self.alpha1.append(alpha1)
        alpha2 = orig_vector[11]
        self.alpha2.append(alpha2)
        theta = orig_vector[12]
